...
{
    // Steamworks is not ready or unavailable. Retry later or keep single-player behavior active.
    return;
}
...
MemberInfo? host = client.GetHostMember();
ulong localSteamId = client.LocalPlayerId64;
